...
model.load_weights('./ckpt/model_weight.ckpt')

gene = MGene(batch_size=512)
score = model.evaluate_generator(gene, steps=100, verbose=1)
print(score)
#%%
k = gene.__getitem__(0)
e = model.predict(k[0][0].reshape(-1,38,64))